...
#define SCL_OUT 	;//(P4DIR|=BIT2) //置位scl
#define SET_SCL SCL=1;//(P4OUT|=BIT2) //置位scl
#define CLE_SCL SCL=0;//(P4OUT&=~BIT2)//清楚scl

                    
#define SDA_OUT ;//(P4DIR|=BIT3)
#define SDA_INT ;//(P4DIR&=~BIT3)
#define SET_SDA SDA=1;//(P4OUT|=BIT3)//置位sda
#define CLE_SDA SDA=0;//(P4OUT&=~BIT3)//清楚sda
